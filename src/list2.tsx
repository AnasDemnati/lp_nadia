...
const pages = [
  { title: 'Transactions', icon: <InboxIcon /> },
  { title: 'Contrat', icon: <InboxIcon  /> },
  { title: 'Les Utilisateurs', icon: <InboxIcon  /> },
  { title: 'Tarifs', icon: <InboxIcon  /> },
];
      ...
      <Card sx={{ width: '100%', marginLeft: '-35%', marginRight: '-35%' }}>
        <CardContent>
          <Grid container spacing={5}>
            ...
            <AccordionDetails>
                <Typography sx={{color:'#a9afc'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui eveniet cumque itaque quia nostrum doloremque perspiciatis. Magni nulla maxime dignissimos ratione hic sunt, deserunt quae recusandae accusamus quisquam exercitationem tempora.</Typography>
            </AccordionDetails>
            </Accordion>
            <Accordion style={{marginTop:'5px', boxShadow: 'rgba(33, 35, 38, 0.1) 0px 10px 10px -10px' }}>
            <AccordionSummary expandIcon={   <KeyboardArrowDownOutlinedIcon   style={{fontWeight:'500', fontSize: '1rem',width:'2rem', height:'2rem',color: '#4c5068',boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', borderRadius:'50px' }} />}>
